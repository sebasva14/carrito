...
// Petición GET.
const getApi = async () => {
  const api = await fetch(`https://ecommercebackend.fundamentos-29.repl.co`)
    ...
    for(let i = 0; i < datos.length; i++){
        ...
        <div class="product__container">
            ...
            <div class="product__container__button">
                <button class="car__button add__to__car" id="add__to__car" data-id="${datos[i].id}">Add to car</button>
            </div>
        </div>
        `
    }
